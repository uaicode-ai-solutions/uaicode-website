...
import SaasTypeStep from "@/components/code-lead-wizard/steps/SaasTypeStep";
...
const CodeLeadWizard = () => {
  ...
  const canGoNext = (): boolean => {
    switch (step) {
      ...
      case 11: return form.geographicRegion !== "" && (form.geographicRegion !== "other" || form.geographicRegionOther.trim().length >= 2);
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 11: return <GeographicRegionStep value={form.geographicRegion} otherValue={form.geographicRegionOther} onChange={set("geographicRegion")} onOtherChange={set("geographicRegionOther")} />;
      case 12: return <ThankYouStep wizardId={wizardId} />;
      default: return null;
    }
  };
