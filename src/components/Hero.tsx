      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16 animate-fade-in-up">
          <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-[60px] font-bold mb-6">
            <span className="block sm:inline-block whitespace-normal sm:whitespace-nowrap">Don't Burn $50K on an Unvalidated Idea</span>
            <span className="block sm:inline-block whitespace-nowrap mt-2 sm:mt-0 sm:ml-3 text-gradient-gold">Let's Validate It Together</span>
          </h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-[20px] font-semibold text-muted-foreground mb-6 sm:mb-8 max-w-3xl mx-auto">
            9 out of 10 startups fail because they skip validation. Book a free 45-minute strategy call and get a complete AI-powered market analysis — competitors, viability score, financial projections — live with our founder.
          </p>
          ...
          <div className="glass-card border border-accent/20 px-6 py-4 rounded-2xl inline-flex flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6 mt-2 sm:mt-0 mb-10 sm:mb-10 md:mb-12 text-muted-foreground">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="text-xs sm:text-sm font-medium">Live AI Validation Session</span>
            </div>
          </div>
