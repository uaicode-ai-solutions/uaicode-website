  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-br from-green-500/5 to-green-500/10 border-green-500/20">
        <CardContent className="pt-6">
          <div className="flex items-center gap-6 flex-wrap">
            <ScoreCircle score={Math.min(Math.round(ltvCacRatio * 8), 100)} label="LTV/CAC" color="success" size="lg" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-card/50 border-border/50"><CardContent className="pt-6 text-center"><Clock className="h-5 w-5 mx-auto text-blue-500 mb-2" /><div className="text-2xl font-bold text-foreground">{paybackPeriod}</div><div className="text-xs text-muted-foreground">Payback Period</div></CardContent></Card>
        <Card className="bg-card/50 border-border/50"><CardContent className="pt-6 text-center"><TrendingUp className="h-5 w-5 mx-auto text-green-500 mb-2" /><div className="text-2xl font-bold text-green-500">{ltv}</div><div className="text-xs text-muted-foreground">LTV (Lifetime Value)</div></CardContent></Card>
        <Card className="bg-card/50 border-border/50"><CardContent className="pt-6 text-center"><Target className="h-5 w-5 mx-auto text-amber-500 mb-2" /><div className="text-2xl font-bold text-foreground">{cac}</div><div className="text-xs text-muted-foreground">CAC</div></CardContent></Card>
      </div>
