...
const comparisonData: ComparisonData = {
  uaicode: 18000,
  traditional: 28875, // Average of $25,250 - $32,500
  savings: "38%",
  savingsAmountMin: 87000,
  savingsAmountMax: 174000,
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative h-8 bg-muted/20 rounded-lg overflow-hidden border border-border/30">
            ...
            >
              <span className="text-xs font-medium text-red-300">~$29K</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative h-8 bg-muted/20 rounded-lg overflow-hidden border border-accent/30">
            ...
            >
              <span className="text-xs font-medium text-accent-foreground">$18K</span>
            </div>
          </div>
        </div>
      </div>
