...
const stats = [
  { label: "Total ICPs", value: "0", icon: Target, change: "—" },
  { label: "Segments", value: "0", icon: Users, change: "—" },
  { label: "Match Rate", value: "0%", icon: TrendingUp, change: "—" },
  { label: "Regions", value: "0", icon: Globe, change: "—" },
];

const ICPOverview = () => {
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-white">ICPs</h2>
